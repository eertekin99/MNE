...
def read_data(param):
    ...
    out_t_labels = tensorflow.keras.utils.to_categorical(epochs_target.events[:, 2], 2)
    out_n_labels = tensorflow.keras.utils.to_categorical(epochs_non_target.events[:, 2] - 10, 2)
