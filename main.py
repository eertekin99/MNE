...
def print_help():
    ...
    print("You can choose from these classifiers: lda, lor, svm, cnn, rnn\n")
...
if classifier != 'cnn' and classifier != 'rnn' and classifier != 'lda' and classifier != 'svm' and classifier != 'lor':
...
elif classifier == 'lda' or classifier == 'svm' or classifier == 'lor':
